...
export default function SurfaceSegmentationCard({ segmentation, city }) {
  ...
  return (
    <div className="glass-panel rounded-2xl p-4 flex flex-col justify-between transition-all hover:border-orange-500/30">
      {/* Header */}
      <div className="flex items-center justify-between pb-3 border-b border-gray-200/60 dark:border-white/[0.06]">
        ...
        <div className="px-2.5 py-1 rounded-lg glass-panel-subtle border border-orange-500/20 text-xs font-mono text-orange-500">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
        {/* Buildings */}
        <div className="p-3 rounded-xl glass-panel-subtle flex flex-col justify-between hover:border-slate-400/40 transition-colors">
        ...
        {/* Tree Canopy */}
        <div className="p-3 rounded-xl glass-panel-subtle flex flex-col justify-between hover:border-emerald-500/40 transition-colors">
          <div className="flex items-center gap-1.5 mb-1">
        ...
        {/* Plant Cover */}
        <div className="p-3 rounded-xl glass-panel-subtle flex flex-col justify-between hover:border-cyan-500/40 transition-colors">
          <div className="flex items-center gap-1.5 mb-1">
          ...
          <div className="flex items-baseline justify-between">
            ...
            <span className="text-[10px] font-mono text-cyan-400/80">Vegetation</span>
          </div>
        </div>

        {/* Ground Soil */}
        <div className="p-3 rounded-xl glass-panel-subtle flex flex-col justify-between hover:border-amber-500/40 transition-colors">
          <div className="flex items-center gap-1.5 mb-1">
          ...
          <div className="flex items-baseline justify-between">
            ...
            <span className="text-[10px] font-mono text-amber-500/80">Porous Soil</span>
          </div>
        </div>
      </div>
    </div>
