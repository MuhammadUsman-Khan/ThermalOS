        ...
        <div className="space-y-3 font-sans text-xs">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 font-mono">
            ...
            <div className="p-3 rounded-lg border border-rose-500/20 bg-rose-500/5 flex items-center justify-between">
              ...
              <span className="px-2 py-0.5 rounded text-[10px] font-semibold uppercase bg-rose-500 text-white">
                {data.heat_stress_risk || "EXTREME"}
              </span>
            </div>
            <div className="p-3 rounded-lg border border-rose-500/20 bg-rose-500/5 flex items-center justify-between">
              <span className="text-rose-400 font-medium">Civic Alert:</span>
              <span className="px-2 py-0.5 rounded text-[10px] font-semibold uppercase bg-rose-500/20 text-rose-400 border border-rose-500/30">
          ...
          <div className="p-3.5 rounded-xl border border-rose-500/20 bg-rose-500/5 space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-xs font-semibold uppercase text-rose-500">
                Emergency Civic & Field Dispatch Protocol
              </span>
            </div>
            <p className="font-mono text-xs leading-relaxed p-3 rounded-lg border border-rose-500/20 bg-white/70 dark:bg-black/50 text-gray-800 dark:text-zinc-200">
