...
export default function AgentTwoModal({ isOpen, onClose, city, currentTemp, loading, error, data }) {
  return (
    <ModalShell
      ...
      onClose={onClose}
      icon={
        <div className="h-8 w-8 rounded-lg bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-cyan-500">
      ...
      {loading ? (
        ...
        <div className="space-y-3 font-sans text-xs">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 font-mono">
            ...
            <div className="p-3 rounded-lg border border-cyan-500/20 bg-cyan-500/5 flex items-center justify-between">
              <span className="text-cyan-600 dark:text-cyan-400 font-medium">Target Pre-Cool:</span>
            ...
            <div className="p-3 rounded-lg border border-emerald-500/20 bg-emerald-500/5 flex items-center justify-between">
              <span className="text-emerald-600 dark:text-emerald-400 font-medium">Grid Load Shift:</span>
          ...
          <div className="p-3.5 rounded-xl border border-cyan-500/20 bg-cyan-500/5 space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-xs font-semibold uppercase text-cyan-600 dark:text-cyan-400">
                HVAC Pre-Cooling Action Plan
              </span>
            </div>
            <p className="font-mono text-xs leading-relaxed p-3 rounded-lg border border-cyan-500/20 bg-white/70 dark:bg-black/50 text-slate-800 dark:text-zinc-200">
              {currentTemp != null
