    ...
    >
      {loading ? (
        ...
        <div className="space-y-3 font-sans text-xs">
          <div className="flex items-center justify-between p-3 rounded-lg border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/[0.02] font-mono">
            <span className="text-gray-500 dark:text-zinc-400">
              Target AOI: <strong className="text-slate-900 dark:text-white">{auditReport.city || city}</strong>
            </span>
            <span className="text-gray-500 dark:text-zinc-400">
          ...
          <div className="p-3.5 rounded-xl border border-rose-500/20 bg-rose-500/5 space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-xs font-semibold text-rose-600 dark:text-rose-400 uppercase">
            ...
            <p className="text-xs leading-relaxed font-mono text-slate-700 dark:text-zinc-300 pl-5">
          ...
          <div className="p-3.5 rounded-xl border border-amber-500/20 bg-amber-500/5 space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-xs font-semibold text-amber-600 dark:text-amber-400 uppercase">
