        ...
        <div className="space-y-3 font-sans text-xs">
          ...
          <div className="p-3.5 rounded-xl border border-orange-500/20 bg-orange-500/5 space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-xs font-semibold text-orange-400 uppercase">
          ...
          <div className="p-3.5 rounded-xl border border-orange-500/30 bg-orange-500/10 space-y-2">
            ...
            <div className="pt-1 pl-5 flex items-center gap-3">
              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-orange-500/20 border border-orange-500/30 text-orange-400 font-mono text-xs">
