...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] dark:bg-black text-slate-900 dark:text-zinc-100 font-sans relative overflow-hidden transition-colors duration-300 flex flex-col selection:bg-[#FF6B2B]/30 selection:text-orange-900 dark:selection:text-white">
      ...
      {/* Top Right Orange Glow (Exact Match) */}
      <div className="fixed top-[-10%] right-[-5%] w-[600px] h-[600px] rounded-full bg-orange-600/20 blur-[120px] pointer-events-none z-0" />
      {/* Bottom Center Red Glow (Exact Match) */}
      <div className="fixed bottom-[-10%] left-[20%] w-[800px] h-[500px] rounded-full bg-red-600/15 dark:bg-red-900/10 blur-[150px] pointer-events-none z-0" />
